...
py2pd is a fork and extensive rewrite of Dylan Burati's [puredata-compiler](https://github.com/dylanburati/puredata-compiler) using some of the ideas from a sibling project, [py2max](https://github.com/shakfu/py2max).
